...
fn from_existing() {
    ...
    let parsec = TestParsec::<Transaction, _>::from_existing(
        ...
        Box::new(new_rng(&mut common_rng)),
    );
...
fn from_parsed_contents() {
    ...
    let parsec =
        TestParsec::from_parsed_contents(parsed_contents, Box::new(new_rng(&mut common_rng)));
...
fn unpolled_observations() {
    ...
    let mut alice =
        TestParsec::from_parsed_contents(alice_contents, Box::new(new_rng(&mut common_rng)));
...
mod handle_malice {
    ...
    fn genesis_event_not_after_initial() {
        ...
        let mut dave =
            TestParsec::from_parsed_contents(dave_contents, Box::new(new_rng(&mut common_rng)));
    ...
    fn genesis_event_creator_not_genesis_member() {
        ...
        let mut eric =
            TestParsec::from_parsed_contents(eric_contents, Box::new(new_rng(&mut common_rng)));
